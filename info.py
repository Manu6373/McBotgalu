...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002350804081'))  # Bin channel id (make sure bot is admin)
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL = int(environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL', '-1002350804081'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002567248510'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002653255036')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002639274240').split()]
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002653255036').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002653255036').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://manud8861:KsTEdxd7V2pXngy8@cluster0.dywqewp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://manud8861:KsTEdxd7V2pXngy8@cluster0.dywqewp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DREAMCINEZONE_VERIFIED_LOG = int(environ.get('DREAMCINEZONE_VERIFIED_LOG', '-1002350804081'))  # Log channel id (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/maviezzsearxh')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/McMoviesKA')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/McChatz_bot')
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/McMoviesKA')
