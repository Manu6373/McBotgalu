...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    MVE_NT_FND = """<b>𝑻𝒉𝒊𝒔 𝑴𝒐𝒗𝒊𝒆 𝑵𝒐𝒕 𝑭𝒐𝒖𝒏𝒅 𝑰𝒏 𝑴𝒚 𝑫𝒂𝒕𝒂𝑩𝒂𝒔𝒆...😌\n\n<blockquote>ನನ್ನಲ್ಲಿ ಇಲ್ಲ ಕ್ಷಮಿಸಿ....🙁.ನಿಮಗೆ ಮೂವಿ ಬೇಕಾದರೆ ನಮ್ಮ ಈ ಮೂವಿ ಬೇಕಾದರೆ ಅಡ್ಮಿನ್ ಬಳಿ ಕೇಳಿರಿ 👇</blockquote></b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/McMoviesKA'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
